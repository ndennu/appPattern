...
public class TodoItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            final View foregroundView = ((TodoViewHolder) viewHolder).card_view;
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        listener.onSwiped((TodoViewHolder) viewHolder, direction, viewHolder.getAdapterPosition());
    }
    ...
    public interface TodoItemTouchHelperListener {
        void onSwiped(TodoViewHolder viewHolder, int direction, int position);
    }
}
